...
@section('title', 'Pertanian Desa Ajakkang')
@section('meta_description', 'Data komoditas dan kelompok pertanian masyarakat Desa Ajakkang.')

@section('page-title')
@component('components.page-title')
    @slot('title', 'Pertanian Desa')
    @slot('description', 'Data komoditas dan kelompok pertanian masyarakat Desa Ajakkang.')
...
<section class="section py-3">
    <div class="container" data-aos="fade-up">
        ...
        <div class="modern-tabs-wrapper mb-3 tab">
            <div class="modern-tabs" id="pertanianTab" role="tablist">
                        ...
                        <div class="komoditas-card">
                            <div class="komoditas-header">
                                ...
                                <div class="komoditas-info">
                                    ...
                                    @php
                                        $badge = match($item->jenis_tanaman) {
                                            'Pangan' => ['color' => 'success', 'icon' => 'grain'],
                                            'Hortikultura' => ['color' => 'warning', 'icon' => 'basket'],
                                            'Perkebunan' => ['color' => 'info', 'icon' => 'tree'],
                                            default => ['color' => 'secondary', 'icon' => 'leaf']
                                        };
                                    @endphp
                                    <span class="badge-xs badge-{{ $badge['color'] }}">
                                        <i class="bi bi-{{ $badge['icon'] }}"></i> {{ $item->jenis_tanaman }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="komoditas-body">
                                <div class="info-row">
                                    ...
                                    <div class="info-text">
                                        <small class="text-muted">Musim Tanam</small>
                                        <div class="fw-semibold">{{ $item->musim_tanam ?? 'Tidak ditentukan' }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="fw-semibold">{{ $item->estimasi_panen_hari }} Hari</div>
                                    </div>
                                </div>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="fw-semibold">
                                            {{ number_format($item->rata_hasil_panen, 2) }} {{ $item->satuan_hasil }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="empty-state-sm">
                            ...
                            <div>
                                ...
                                <p>Data komoditas pertanian belum tersedia</p>
                            </div>
                        </div>
                    </div>
                    @endforelse
                ...
                <div class="row g-2">
                            ...
                            <div class="kelompok-header">
                                ...
                                <div class="kelompok-info">
                                    ...
                                    <span class="badge-xs badge-light">
                                        <i class="bi bi-person-check"></i> {{ $item->anggota->count() }} Anggota
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="kelompok-body">
                                ...
                                <div class="ketua-box">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-semibold">{{ $item->ketua->nama ?? 'Belum Ditentukan' }}</div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="empty-state-sm">
                            <i class="bi bi-people"></i>
                            <div>
                                <strong>Tidak Ada Kelompok Tani</strong>
                                <p>Data kelompok pertanian belum tersedia</p>
                            </div>
                        </div>
                    </div>
                    @endforelse
