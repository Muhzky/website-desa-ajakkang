                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        <div class=" h-100 border-0">
                            <div class=" card card-custom shadow-sm card-body p-4">
                    ...
                    <div class="col-12">
                        <div class="alert alert-warning text-center">
                            Belum ada dokumen perencanaan tersedia.
                        </div>
                    </div>
                    @endforelse
            ...
            <nav>
                <ul class="pagination pagination-sm custom-pagination mb-0">
                    ...
                    <li class="page-item {{ $documents->onFirstPage() ? 'disabled' : '' }}">
                        <a class="page-link"
                            href="{{ $documents->previousPageUrl() ?? 'javascript:void(0)' }}">
                            ‹
                        </a>
                    </li>
                    ...
                    $end = min($documents->currentPage() + 2, $documents->lastPage());
                    @endphp
                    ...
                    @for ($i = $start; $i <= $end; $i++)
                        ...
                        <li class="page-item {{ $documents->hasMorePages() ? '' : 'disabled' }}">
                            <a class="page-link"
                                href="{{ $documents->nextPageUrl() ?? 'javascript:void(0)' }}">
                                ›
                            </a>
                        </li>
